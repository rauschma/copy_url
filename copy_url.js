...
(function() {
    ...
    var hostEntries = [
        ...
        [ "badassjs.com", { re: /^(.*) - Badass JavaScript$/, twit: "@badass_js" } ],
        [ "blog.chromium.org", { re: /^Chromium Blog: (.*)$/, twit: "@ChromiumDev" } ],
        [ "blog.nodejs.org", { re: /^(.*) « node blog$/, twit: "@nodejs" } ],
        [ "dailyjs.com", { re: /^DailyJS: (.*)$/, twit: "@dailyjs" } ],
